<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ColumnEdit.aspx.cs" Inherits="CMSSystem.ContentManager.ColumnEdit" %>
...
<body ng-controller="columnbodyyz">
    <form name="myForm" class="layui-form layui-form-pane">
        <blockquote class="layui-elem-quote">编辑栏目</blockquote>
        ...
        <div>
            ...
            <div id="linkopen" style="display: none;">
                <div class="layui-form-item">
    ...
    <script src="../scripts/JSManager/ContentManager/ColumnEdit.js"></script>
</body>
</html>
