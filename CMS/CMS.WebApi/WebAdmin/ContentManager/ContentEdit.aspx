<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContentEdit.aspx.cs" Inherits="CMSSystem.ContentManager.ContentEdit" %>
...
<body>
    <form id="myForm" name="myForm" class="layui-form layui-form-pane" ng-app="myContent" ng-controller="contentController">
        <blockquote class="layui-elem-quote">
            编辑内容
            <div class="fr" style="position: relative; top: -8px;">
                <input type="button" id="backtop" class="layui-btn" value="返回" onclick="goback();" />
            </div>
        </blockquote>
        ...
        <div style="width: 1200px;">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">推荐和置顶</label>
                <div class="layui-input-inline">
            ...
            <div class="layui-form-item" id="diveditor" style="display: block;">
            ...
            <div class="layui-form-item">
                ...
                <div class="dateTimeWidth fl">
                    <input type="hidden" id="oldPubTime" />
                    <input type="hidden" id="oldpub" />
                    <input class="layui-input" placeholder="设置发布时间" id="PubTime" onclick="laydate({ istime: true, format: 'YYYY-MM-DD hh:mm:ss', choose: function (dates) { $('#PubTime').val(getNowFormatTime(dates)); } })" disabled />
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="dateTimeWidth fl">
                    <input class="layui-input" placeholder="设置过期时间" id="GQTime" onclick="laydate({ istime: true, format: 'YYYY-MM-DD hh:mm:ss', choose: function (dates) { $('#GQTime').val(getNowFormatTime(dates)); } })" disabled />
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <label class="layui-form-label" id="ViewNums">0</label>
                </div>
            </div>
            <div class="layui-form-item  layui-form-text" id="divArticleAudit" style="display: block;">
                <label class="layui-form-label">审核意见</label>
                <div class="layui-input-block">
                    <textarea id="ArticleAudit" name="ArticleAudit" placeholder="审核意见" class="layui-textarea"></textarea>
                </div>
            </div>
            <div class="layui-collapse" id="divArticleAuditList" style="display: none;">
                <div class="layui-colla-item">
                    <h2 class="layui-colla-title">内容详细操作记录</h2>
            ...
            <div class="layui-form-item" style="padding-top: 10px;">
                <div class="layui-input-block">
                    <input type="button" id="pauseSave" class="layui-btn" value="保存" data-ng-class="{true:'layui-btn-disabled',false:''}[myForm.$invalid]" data-ng-disabled="myForm.$invalid" />
                    ...
                    <input type="button" id="shtg" class="layui-btn" value="审核通过" style="display: inline-block;" data-ng-class="{true:'layui-btn-disabled',false:''}[myForm.$invalid]" data-ng-disabled="myForm.$invalid" />
                    <input type="button" id="takeback" class="layui-btn" value="退回" style="display: inline-block;" data-ng-class="{true:'layui-btn-disabled',false:''}[myForm.$invalid]" data-ng-disabled="myForm.$invalid" />
                    <input type="button" id="back" class="layui-btn" value="返回" onclick="goback();" />
                </div>
            </div>
        </div>
    ...
    <script src="../scripts/JSManager/ContentManager/ContentEdit.js"></script>
</body>
</html>
