...
layui.define(['element', 'common'], function (exports) {
    ...
    Navbar.prototype.on = function (events, callback) {
        ...
        if (eventName === 'click') {
            //alert(JSON.stringify(_con.children('ul').find('li')[0]))
    ...
    function getHtml(data) {
        var ulHtml = '<div id="sidebar" class="sidebar-fold" style="color: #fff;"><i class="fa fa-bars"></i></div><ul class="layui-nav layui-nav-tree beg-navbar">';
