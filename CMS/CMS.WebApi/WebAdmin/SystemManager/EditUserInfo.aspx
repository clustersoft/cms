<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditUserInfo.aspx.cs" Inherits="CMSSystem.SystemManager.EditUserInfo" %>
...
<body ng-app="myUser" ng-controller="userController">
    ...
    <form name="myForm" class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input id="username" name="username" class="layui-input" type="text" placeholder="请输入" autocomplete="off" ng-minlength="2" ng-model='username' required>
