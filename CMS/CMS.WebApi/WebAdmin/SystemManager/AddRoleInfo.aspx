<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddRoleInfo.aspx.cs" Inherits="CMSSystem.SystemManager.AddRoleInfo" %>
...
<body ng-app="myRole" ng-controller="roleController">
    ...
    <form name="myForm" class="layui-form layui-form-pane">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input id="rolename" name="rolename" class="layui-input" type="text" placeholder="请输入" autocomplete="off" ng-model='user.rolename' ng-keyup="isDup(user.rolename);" required>
                        ...
                        <table class="layui-table" style="margin: 0px;">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th name='rolecheck'>
                                        <input type='checkbox' name='catechk' value='on' lay-filter="all_edit" title='编辑全选' /><input type='checkbox' name='catechk' value='on' lay-filter='all_audit' title='审核全选' />
                                    </th>
                                </tr>
                            </thead>
                            <tbody id="cateroles">
    ...
    <script src="../scripts/JSManager/SystemManager/AddRoleInfo.js"></script>
</body>
</html>
