<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddPicLinkInfo.aspx.cs" Inherits="CMSSystem.PublicityManager.AddPicLinkInfo" %>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <div id="uploader-demo" class="layui-inline marginleft">
                    ...
                    <input type="button" id="deletePic" class="layui-btn layui-btn-primary" style="float:left; margin-left:15px; display:none;"  value="删除图片" />
                    </div>
                </div>
            </div>
        </div>
...
<script src="../scripts/JSManager/PublicityManager/AddPicLinkInfo.js"></script>